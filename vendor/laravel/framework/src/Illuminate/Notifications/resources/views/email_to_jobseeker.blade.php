                                        ...
                                        <table cellspacing="0" cellpadding="0" class="force-full-width">
                                            <tr>
                                                <td style="font-size:40px; font-weight: 600; color: #ffffff; text-align:center;"
                                                    ...
                                                    Good News ! Your application has been approved by the Company !
                                                    <br/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;"
                                                    ...
                                                    We would like you to know that your applied job to the Company has been
                                                    approved! Details
                                                    below.
                                                </td>
                                            </tr>
                                        ...
                                        <center>
                                            ...
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td style="text-align: left;">
                                                        <br>
                                                        <b>P.S</b> : Company will <u>directly send Email</u> to You for interview
                                                        schedule.<br>
                                                        Please check on Magang.com, in "<b>Applied Job</b>" menu.<br><br>
                                        ...
                                        <table cellspacing="0" cellpadding="0" bgcolor="#363636"
                                            ...
                                            <tr>
                                                <td style="font-size:12px;" align="center">
                                                    <br>
                                                    <br>
                                                    <a href="https://www.sendwithus.com/resources/templates/sunday">Design By Awesome Inc (sendwithus)</a>
                                                    &nbsp;
                                                </td>
                                            </tr>
                                        </table>
